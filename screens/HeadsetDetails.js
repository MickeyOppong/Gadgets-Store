...
export default function HeadsetDetails({route, navigation}) {
    return (
<SafeAreaView style={{flex:1}}>
      <ScrollView style={{backgroundColor: "#fff", borderBottomEndRadius: 40, height: "80%",}}>
        <View style ={{width: "100%", margin: 10}}>
          <Image
            style={styles.image}
            source={require('../assets/headset.jpg')}
          />
        </View>
        <View style={styles.infoContainer}>
          <Text style={styles.name}>Gaming Headset</Text>
          <Text style={styles.price}>GH$ 300</Text>
          <Text style={styles.description}>Best for Xbox gaming</Text>
        </View>
      </ScrollView>
